...
cp $SCRIPT_PATH/finder.sh home
cp $SCRIPT_PATH/finder-test.sh home

mkdir home/conf
cp $SCRIPT_PATH/conf/username.txt home/conf/
cp $SCRIPT_PATH/conf/assignment.txt home/conf/

cp $SCRIPT_PATH/autorun-qemu.sh home
